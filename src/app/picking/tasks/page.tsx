...
export default function PickingTasksPage() {
  ...
  const sorted = [...filtered].sort((a, b) => {
    ...
    if (sortField === 'product')
      return productName(a.productId).localeCompare(productName(b.productId)) * d
    if (sortField === 'location')
      return locationCode(a.locationId).localeCompare(locationCode(b.locationId)) * d
  ...
  const pendingCount = state.pickingTasks.filter(
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground text-sm">Pendientes / asignadas</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground text-sm">Picking parcial</p>
                ...
                return (
                  <TableRow key={task.id}>
                    ...
                    <TableCell className="text-right tabular-nums">
                      {formatNumber(task.requestedQuantity)}
                    </TableCell>
                    <TableCell className="text-right tabular-nums">
                      {formatNumber(task.pickedQuantity)}
                    </TableCell>
                    <TableCell>
          ...
          {pickDialog.data && (
            <div className="space-y-4 py-2">
              <div className="text-muted-foreground space-y-1 text-sm">
                <p>
                  Tarea: <span className="text-foreground font-medium">{pickDialog.data.code}</span>
                </p>
                <p>
                  Producto:{' '}
                ...
                <p>
                  ...
                  <span className="text-foreground font-mono font-medium">
                    {pickDialog.data.locationCode}
                  </span>
                </p>
                <p>
                  Solicitado:{' '}
                  <span className="text-foreground font-medium">
                    {pickDialog.data.requestedQuantity}
                  </span>
                </p>
              </div>
