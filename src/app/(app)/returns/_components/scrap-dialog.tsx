              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    s.include
                      ? 'border-red-200 bg-red-50/30 dark:border-red-400/30 dark:bg-red-950/20'
                      : 'border-muted-foreground/30 bg-muted/20 dark:border-muted-foreground/30 border-dashed opacity-60 dark:bg-transparent'
                  )}
                >
