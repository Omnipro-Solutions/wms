    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <KpiCard
          ...
          value={activeCount}
          label="Activas"
          sublabel="Conexiones operativas"
          tone="green"
        />
        <KpiCard
          icon={Zap}
      ...
      {errorIntegrations.length > 0 && (
        <div className="flex items-start gap-3 rounded-xl border border-red-200 bg-red-50 px-4 py-3 dark:border-red-400/30 dark:bg-red-950/20">
