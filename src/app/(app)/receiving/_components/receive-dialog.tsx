  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Input
        ...
        className={cn(
          'h-14 flex-1 rounded-xl border-2 bg-white text-center text-3xl font-bold tabular-nums dark:bg-zinc-900',
...
export const ReceiveDialog = ({ state }: Props) => {
  ...
  return (
    ...
    >
      <DialogContent className="max-h-screen max-w-6xl! gap-0 overflow-y-auto p-0">
        {/* ── Header ── */}
        <div className="border-b bg-white px-7 py-5 dark:bg-zinc-900">
        ...
        {data && (
          <div className="grid grid-cols-1 divide-y md:grid-cols-5 md:divide-x md:divide-y-0">
            ...
            <div className="bg-muted/30 flex flex-col gap-5 px-6 py-6 md:col-span-2">
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-foreground/15 flex items-center justify-between rounded-lg border-2 bg-white px-4 py-3 dark:bg-zinc-900">
              ...
              <div>
                <Field className="w-full max-w-sm">
                  ...
                  <Progress
                    ...
                    id="progress-upload"
                    variant={
                      isOverCount ? 'destructive' : progressPct === 100 ? 'success' : 'default'
                    }
                  />
                </Field>
              ...
              {totalCounted > 0 &&
                (isOverCount ? (
                  ...
                  <div className="border-border flex items-center gap-2 rounded-lg border bg-white px-3 py-3 text-sm dark:bg-zinc-900">
                  ...
                  <div className="border-border flex items-start gap-2 rounded-lg border bg-white px-3 py-3 text-sm dark:bg-zinc-900">
            ...
            <div className="flex flex-col gap-5 px-7 py-6 md:col-span-3">
              ...
              {hasUomChoice && (
                <div className="space-y-1.5 rounded-lg border bg-white p-4 dark:bg-zinc-900">
                  ...
                  {selectedUomId && selectedUomId !== baseUomId && (
                    <p className="text-muted-foreground text-xs">
                      Las cantidades se convertirán automáticamente a la UM base al ingresar al
                      stock.
                    </p>
                  )}
                </div>
              ...
              {requiresSerial && goodQtyNum > 0 && (
                <div className="space-y-2 rounded-lg border bg-white p-4 dark:bg-zinc-900">
                  <Label
                    htmlFor="rcv-serials"
                    className="flex items-center gap-2 text-sm font-semibold"
                  >
                  ...
                  {!serialsDuplicated && parsedSerials.length === goodQtyNum && goodQtyNum > 0 && (
                    <p className="flex items-center gap-1 text-xs text-green-700 dark:text-emerald-300">
                      <CheckCircle2 className="size-3" /> {goodQtyNum} series capturadas
                      correctamente.
                    </p>
                  )}
                </div>
        ...
        {/* ── Footer ── */}
        <div className="flex items-center justify-between border-t bg-white px-7 py-4 dark:bg-zinc-900">
