...
export const productivityColumns: ColumnDef<ProductivityRow>[] = [
  {
    ...
    cell: ({ row }) => <span className="font-medium">{row.getValue('operatorName')}</span>,
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-right text-red-600 tabular-nums">
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div
          className={`text-right font-semibold tabular-nums ${eff >= 90 ? 'text-green-700' : eff >= 70 ? 'text-amber-600' : 'text-red-600'}`}
        >
          {formatPercent(eff)}
        </div>
      )
...
export const discrepancyColumns: ColumnDef<DiscrepancyRow>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => <span className="font-mono text-sm">{row.getValue('referenceCode')}</span>,
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div
          className={`text-right font-semibold tabular-nums ${diff < 0 ? 'text-red-600' : 'text-green-700'}`}
        >
          {diff > 0 ? '+' : ''}
          {formatNumber(diff)}
        </div>
...
export const warehouseInventoryColumns: ColumnDef<WarehouseInventoryRow>[] = [
  {
    ...
    header: ({ column }) => <DataTableColumnHeader column={column} title="Bodega" />,
...
export const movementColumns: ColumnDef<MovementRow>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => <span className="text-sm">{row.getValue('productName')}</span>,
  },
  {
  ...
  },
  {
    ...
    header: 'Referencia',
    cell: ({ row }) => (
      <span className="text-muted-foreground font-mono text-xs">{row.getValue('referenceId')}</span>
    ),
    enableSorting: false,
  },
  {
    accessorKey: 'operatorName',
    header: ({ column }) => <DataTableColumnHeader column={column} title="Operador" />,
    cell: ({ row }) => <span className="text-sm">{row.getValue('operatorName')}</span>,
  },
  {
...
export const otifColumns: ColumnDef<OtifRow>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => <DataTableColumnHeader column={column} title="Estado OTIF" />,
    cell: ({ row }) => {
  ...
  },
  {
    ...
    header: ({ column }) => <DataTableColumnHeader column={column} title="Despachado" />,
    cell: ({ row }) => (
      <span className="text-sm">
