      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Select value={dockId} onValueChange={(v) => { setDockId(v); setErrors((e) => ({ ...e, dockId: undefined })) }}>
          ...
          <div className="space-y-1.5">
            ...
            <Select value={timeSlot} onValueChange={(v) => { setTimeSlot(v); setErrors((e) => ({ ...e, timeSlot: undefined })) }}>
